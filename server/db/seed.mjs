// Standalone seed script: node server/db/seed.mjs
...
db.exec(`
  CREATE TABLE IF NOT EXISTS users (
    ...
    email TEXT UNIQUE, password_hash TEXT, role TEXT DEFAULT 'patient',
    first_name TEXT, last_name TEXT, dob TEXT, ssn TEXT, insurance_id TEXT,
    phone TEXT, address TEXT, settings TEXT DEFAULT '{}', reset_token TEXT,
    created_at TEXT DEFAULT (datetime('now'))
  );
  CREATE TABLE IF NOT EXISTS records (
    id INTEGER PRIMARY KEY AUTOINCREMENT, patient_id INTEGER, doctor_id INTEGER,
    title TEXT, record_type TEXT, body TEXT, result_value TEXT,
    created_at TEXT DEFAULT (datetime('now'))
  );
  CREATE TABLE IF NOT EXISTS appointments (
    id INTEGER PRIMARY KEY AUTOINCREMENT, patient_id INTEGER, doctor_id INTEGER,
    scheduled_for TEXT, reason TEXT, status TEXT DEFAULT 'scheduled',
    created_at TEXT DEFAULT (datetime('now'))
  );
  CREATE TABLE IF NOT EXISTS messages (
    id INTEGER PRIMARY KEY AUTOINCREMENT, thread_id INTEGER, sender_id INTEGER,
    recipient_id INTEGER, body TEXT, created_at TEXT DEFAULT (datetime('now'))
  );
  CREATE TABLE IF NOT EXISTS prescriptions (
    id INTEGER PRIMARY KEY AUTOINCREMENT, patient_id INTEGER, doctor_id INTEGER,
    medication TEXT, dosage TEXT, notes TEXT, created_at TEXT DEFAULT (datetime('now'))
  );
`)
...
const users = [
  ['admin@medisync.health', md5('admin123'), 'admin', 'Alice', 'Admin', '1980-02-11', '111-22-3333', 'INS-ADM-0001', '555-0100', '1 Admin Way'],
  ['dr.house@medisync.health', md5('doctor123'), 'doctor', 'Gregory', 'House', '1959-06-11', '222-33-4444', 'INS-DOC-0002', '555-0101', '221B Clinic Rd'],
  ['dr.grey@medisync.health', md5('doctor123'), 'doctor', 'Meredith', 'Grey', '1978-11-04', '333-44-5555', 'INS-DOC-0003', '555-0102', '5 Seattle Ave'],
  ['john.doe@example.com', md5('patient123'), 'patient', 'John', 'Doe', '1990-07-23', '444-55-6666', 'INS-PAT-1001', '555-0200', '12 Maple St'],
  ['jane.roe@example.com', md5('patient123'), 'patient', 'Jane', 'Roe', '1985-03-15', '555-66-7777', 'INS-PAT-1002', '555-0201', '34 Oak St'],
  ['bob.smith@example.com', md5('patient123'), 'patient', 'Bob', 'Smith', '1972-12-01', '666-77-8888', 'INS-PAT-1003', '555-0202', '56 Pine St'],
]
const insUser = db.prepare(`INSERT INTO users (email,password_hash,role,first_name,last_name,dob,ssn,insurance_id,phone,address) VALUES (?,?,?,?,?,?,?,?,?,?)`)
...
console.log('Seeded medisync database at', abs)
