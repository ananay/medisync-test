import { reactive, effectScope, hasInjectionContext, getCurrentInstance, inject, toRef, unref, version, h, shallowRef, shallowReactive, isReadonly, isReactive, toRaw, isRef, isShallow, defineComponent, computed, ref, resolveComponent, provide, watch, Suspense, nextTick, Transition, mergeProps, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/admin-CexGdEXW.js").then((m) => m.default || m)
  },
  {
    name: "book",
    path: "/book",
    ...
    component: () => import("./_nuxt/book-xTjIli5_.js").then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    ...
    component: () => import("./_nuxt/dashboard-Ctxchwb8.js").then((m) => m.default || m)
  },
  {
    name: "doctor",
    path: "/doctor",
    ...
    component: () => import("./_nuxt/doctor-DsxnnReN.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-CQeFsZyR.js").then((m) => m.default || m)
  },
  {
    name: "labs",
    path: "/labs",
    ...
    component: () => import("./_nuxt/labs-D2-7hf7Z.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login-BHq7h59X.js").then((m) => m.default || m)
  },
  {
    name: "messages",
    path: "/messages",
    ...
    component: () => import("./_nuxt/messages-C0sx0pgd.js").then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    ...
    component: () => import("./_nuxt/profile-6ZcCZ8jf.js").then((m) => m.default || m)
  },
  {
    name: "records-id",
    path: "/records/:id()",
    ...
    component: () => import("./_nuxt/_id_-JF0lDDx4.js").then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    component: () => import("./_nuxt/register-BLk3Ub3I.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isAdmin = computed(() => {
      var _a;
      return ((_a = auth.user.value) == null ? void 0 : _a.role) === "admin";
    });
    const isStaff = computed(() => {
      var _a, _b;
      return ((_a = auth.user.value) == null ? void 0 : _a.role) === "doctor" || ((_b = auth.user.value) == null ? void 0 : _b.role) === "admin";
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_NuxtPage = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app" }, _attrs))}><header class="topbar">`);
      ...
      if (unref(auth).user.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/messages" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Messages`);
            } else {
        ...
        if (isStaff.value) {
          _push(ssrRenderComponent(_component_NuxtLink, { to: "/doctor" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`Doctor`);
              } else {
                return [
                  createTextVNode("Doctor")
                ];
              }
            }),
            _: 1
        ...
        _push(`<a href="#">Logout (${ssrInterpolate(unref(auth).user.value.role)})</a><!--]-->`);
      } else {
        _push(`<!--[-->`);
      ...
      _push(`</nav></header><main class="content">`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main><footer class="footer">MediSync Telehealth — demo environment</footer></div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-FIoYTJYG.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bgm8Vf69.js").then((r) => r.default || r));
